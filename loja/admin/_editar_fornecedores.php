...
<body>
    ...
    $sql = "update fornecedores set nome_fornecedor = '$nome_fornecedor', cpf_cnpj ='$cpf_cnpj', cep = '$cep', logradouro = '$logradouro', numero='$numero', complemento = '$complemento', bairro = '$bairro', cidade = '$cidade', uf = '$uf', email = '$email', celular = '$celular' where id_fornecedor = '$id_fornecedor'";
