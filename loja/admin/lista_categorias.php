...
<body>
    ...
    ?>
    <div class="container">
    <a href="incluir_categorias.php" button type="button" class="btn btn-success">Incluir</a>
        ...
        <tbody>
            ...
            */
            ...
            <tr>
                ...
                <td><a href="editar_categorias.php?id_categoria=<?php echo $id_categoria ?>" button type="button" class="btn btn-warning">Editar</a></td>
            </tr>
            <?php } ?>
        </tbody> 
    </table>
