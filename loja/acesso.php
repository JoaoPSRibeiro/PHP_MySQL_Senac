        ...
        <div class="container" id="tamanho">
            ...
            <form action="login.php" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="email" class="form-control" placeholder="Usuário" autocomplete="off" required>
                </div>

                <div class="form-group">
                    <label><b>Senha</b></label>
                    <input type="password" name="password" class="form-control" placeholder="Senha" autocoplete="off" required>
                </div>
