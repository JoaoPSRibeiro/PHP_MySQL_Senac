 ...
 <table class="table table-hover">
        ...
        <tbody>
            <?php 
                ...
                <td><a href="editar_itens.php?id_item=<?php echo $id_item ?>" button type="button" class="btn btn-warning">Editar</a></td>
                </tr>
                <?php } ?>
        </tbody> 
        </table>
        <table align="right">
            <tr>
                ...
                <td align="right">R$ <?php echo $total_compra?></td>
                <tr>
                <tr><br></tr>
                <td align="right">
                    <a href="https://www.pagseguro.com.br" type="button" class="btn btn-primary">Finalizar Compra</a>
                 </td>
                </tr>
